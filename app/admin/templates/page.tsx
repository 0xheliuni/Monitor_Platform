      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            <Button render={<Link href="/admin/templates/new" />}><PlusIcon />新建模板</Button>
          </div>
        }
      />
              ...
              {templates.map((item) => (
                <tr key={item.id} className="border-b align-top last:border-0">
                  <td className="py-3 pr-4">
                    <Link href={`/admin/templates/${item.id}`} className="font-medium hover:underline">{item.name}</Link>
                  </td>
