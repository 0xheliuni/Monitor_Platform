...
export async function createNotificationAction(formData: FormData) {
  ...
  redirect(withMessage("/admin/notifications", "success", "系统通知已创建"))
}
...
export async function updateNotificationAction(formData: FormData) {
  ...
  redirect(withMessage(`/admin/notifications/${id}`, "success", "系统通知已更新"))
}
...
export async function deleteNotificationAction(formData: FormData) {
  ...
  revalidatePath("/admin")
  revalidatePath("/admin/notifications")
  redirect(withMessage("/admin/notifications", "success", "系统通知已删除"))
}
