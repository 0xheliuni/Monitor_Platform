...
// TODO(Task 10): re-enable DB env checks after data layer is wired
const adminDbReady = false
const adminDbWarnings: string[] = ["数据层迁移中（Task 10）"]
const dbSchema: string | null = null
        ...
        <header className="sticky top-0 z-10 flex h-16 shrink-0 items-center gap-3 border-b bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/80">
          ...
          <div className="flex min-w-0 flex-1 items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <Badge variant={adminDbReady ? "secondary" : "danger"}>
